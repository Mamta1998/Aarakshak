...
@WebServlet("/UpdateProtest")
public class UpdateProtest extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		db.updateProtest(obj);
		out.println("updated");
		
		RequestDispatcher rs=request.getRequestDispatcher("UpdateProtestApplication.jsp");
