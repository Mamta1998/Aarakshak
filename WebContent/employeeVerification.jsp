<!-- Program for taking entries in contact uS form  -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="contact_form">
						<form method="post" action="employeeVericationDone.jsp">
							<fieldset>
								<div class="full field">
								<b><h2><u>Employee's Details</u></h2></b>
									<input type="text" name="eName" placeholder="Employee Name"  required />
								</div>
								<div class="full field">
									<input type="text" name="eConatct" placeholder="Employee Contact"  pattern="[789][0-9]{9}"/>
								</div>
								<div class="full field">
									<input	type="text" name="eEmail" placeholder="Employee Email"  required />
								</div>
								<div class="full field">
									<input type="text" name="eFatherName" placeholder="Employee Father's Name"  required />
								</div>
								<div class="full field">
									<input type="text" name="eAadhar" placeholder="Aadhar Number"  required />
								</div>
								<div class="full field">
									<input type="text" name="pAddress" placeholder="Employee Permanent Address"  required />
								</div>
								<div class="full field">
									<input type="text" name="cAddress" placeholder="Employee Current Address"  required />
								</div>
								<div class="full field">
			...
			<option value="male">Male</option>
								...
								<div class="full field">
									...
									<option disabled selected>Physically Challenged</option>
			...
			<option value="AB-">AB-</option>
								...
								<div class="full field">
									<input type="text" name="organiztion" placeholder=" Organization Name"  required />
								</div>
								<div class="full field">
									<input type="text" name="oAddress" placeholder=" Organization Address"  required />
								</div>
								<div class="full field">
