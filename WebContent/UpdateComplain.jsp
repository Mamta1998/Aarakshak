<!-- Program for updating the Status of FIR complaint  -->
...
<head>
    ...
    <!-- Site Metas -->
    <title>Update FIR Complaints</title>
	...
	try
		{
			...
			String query="Select * from register where Status IN('Pending','Recieved','Under Process','Opened') AND policeStation=?";
...
<%
		...
		while(myrs.next())
			{
				out.println("<tr>");
				out.println("<td>"+ (number++));
				out.println("</td>");
				out.println("<td>"+ myrs.getString("Name"));
				out.println("</td>");
				out.println("<td>"+ myrs.getString("ContactNo"));
				out.println("</td>");
				...
				out.println("</td>");
				out.println("<td>"+ myrs.getString("Complaint"));
				out.println("</td>");
...
<br>	
	<br>
	<center>
	<h2> Select the Trcaking ID to Update:</h2>
	<form method="post" action="Update_Complain">
