...
<!-- Site Metas -->
<title>Recover Tracking Id </title>
...
<section class="inner_banner">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="full">
						<h3>Tracking ID Recovered Successfully</h3>
					</div>
				</div>
			</div>
		</div>
...
try
{
	String check=request.getParameter("ans").replaceAll("\\s","");
	String answer=request.getParameter("a").replaceAll("\\s","");
	String track=request.getParameter("b");
	
	if(check.equals(answer))
	{
		%>
		
		<% out.println("<h1><b><center>"+"Your Tracking Id :"+"<br>");
		out.println(track);
		out.println("</center><b></h1>");%>
