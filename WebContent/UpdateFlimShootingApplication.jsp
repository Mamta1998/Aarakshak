<!-- Program to update status of  flimshooting request application received -->
...
<head>
    ...
    <!-- Site Metas -->
    <title>Update Flim Shooting Request Application</title>
	...
	<section class="inner_banner">
	  <div class="container">
	      <div class="row">
		      <div class="col-12">
			     <div class="full">
				     <h3>Update Flim Shooting Request Application</h3>
				 </div>
			  </div>
		  </div>
	  </div>
...
<%
		try
			...
			String query="Select * from flimshooting where status IN('Pending','Recieved','Under Process','Opened') AND policeStation=?";
...
<table id="customers">
	...
	<br>
	<form method="post" action="UpdateFlimShooting">
