...
<head>
    ...
    <!-- Site Metas -->
    <title>Tenant Verification Section</title>
	...
	<section class="inner_banner">
	  <div class="container">
	      <div class="row">
		      <div class="col-12">
			     <div class="full">
				     <h3>Tenant Verification Section</h3>
				 </div>
			  </div>
		  </div>
	  </div>
                ...
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="showAllTenant.jsp" ><h2><span>Show all application</span></h2></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="UpdateTenant.jsp" ><h2><span>Update application</span></h2></a>
                        </div>
