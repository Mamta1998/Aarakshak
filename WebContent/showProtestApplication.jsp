<!-- Program to view all protest/strike request application recieved -->
...
<head>
    ...
    <!-- Site Metas -->
    <title>Protest/Strike Request Application</title>
	...
	<section class="inner_banner">
	  <div class="container">
	      <div class="row">
		      <div class="col-12">
			     <div class="full">
				     <h3>Protest/Strike Request Applicatio</h3>
				 </div>
			  </div>
		  </div>
	  </div>
		...
		try
			{
				...
				String query="select * from protest where policeStation=?";
