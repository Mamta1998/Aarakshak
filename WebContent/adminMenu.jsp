...
<head>
    ...
    <!-- Site Metas -->
    <title>Complain and Request Menu</title>
                ...
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="Complain_admin.jsp" ><h2><span> FIR Section</span></h2></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="Contact_admin.jsp" ><h2><span>Contact Us Section</span></h2></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="eventOrganiseSection.jsp" ><h2><span>Event Organise Section</span></h2></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="verificationFormSection.jsp" ><h2><span>Verification Form Section</span></h2></a>
                        </div>
