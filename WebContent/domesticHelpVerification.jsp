<!-- Domestic helpverification Form -->
...
<!-- Site Metas -->
<title>Domestic Help Verification Form</title>
	...
	<section class="inner_banner">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="full">
						<h3>Domestic Help Verification Form</h3>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="contact_form">
						<form method="post" action="domesticHelpVerificationDone.jsp">
							<fieldset>
								<div class="full field">
								<b><h2><u>Helper's Details</u></h2></b>
									<input type="text" name="hName" placeholder=" Name"  required />
								</div>
								<div class="full field">
									<input type="text" name="hPhoneNo" placeholder=" Contact Number"  pattern="[789][0-9]{9}"/>
								</div>
								<div class="full field">
									<input type="text" name="hAddress" placeholder="Address"  required />
								</div>
								<div class="full field">
									<input type="text"	name="hCaste" placeholder="Cast"  required />
								</div>
								<div class="full field">
									<input type="text" name="hReligion" placeholder="Religion"  required />
								</div>
								<div class="full field">
									<select name="gender">
						...
						<option value="male">Male</option>
								...
								<div class="full field">
									<input type="text" name="hAadhar" placeholder="Aadhar Number"  required />
								</div>
								<div class="full field">
								<b><h2><u>Helper Previous Employment</u></h2></b>
									<input type="text" name="pName" placeholder=" Name"  required />
								</div>
								<div class="full field">
									<input type="text" name="pContactNo" placeholder="Contact Number"  required />
								</div>
								<div class="full field">
