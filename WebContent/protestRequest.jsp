...
<!-- Site Metas -->
<title>Protest Request Application</title>
...
<button class="p" onclick="window.print()">Print</button>
		<p>
			<form method="post" action="protestRequestDone.jsp">
				To,
				<br>
				...
				Subject:<input type="text" name="subject" placeholder="enter the subject line" required>
				<br>
				<br>
				
				Respected Sir/Madam,<br>
				<textarea rows="20" cols="50" name="content" placeholder="write your application here" required>
				</textarea>
				<br>
				<br>
			 	...
			 	Thanking You, <br>
			 	Your Sincerely<br> 
				 <input type="text" name="signature" placeholder="full name for your signature" required>
			 	<br>
