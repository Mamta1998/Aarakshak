...
<head>
    ...
    <!-- Site Metas -->
    <title>Update Tenant verification Request</title>
...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
	...
	<section class="inner_banner">
	  <div class="container">
	      <div class="row">
		      <div class="col-12">
			     <div class="full">
				     <h3>Update Tenant verification Request</h3>
				 </div>
			  </div>
		  </div>
	  </div>
	...
	<!-- end section -->
		...
		<%
			...
			{	
				...
				String query="select * from tenant where policeStation=?";
	...
	while(myrs.next())
		...
		<center><h1>Tenant's Detail</h1></center>
		...
		<table id="customers">
			...
			<%
			out.println("<tr>");
			out.println("<td>"+ myrs.getString("Tname"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("Tfathername"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("Tphone"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("TcurrentAdd"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("PemanentAdd"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("totalMemeber"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("TofficeAdd"));
			out.println("</td>");
					
			%>
		</table>
	<center><h1>Landlord's Detail</h1></center>
	<table id="customers">
		<tr>
			<th>Name</th>
			<th>ContactNo</th>
		...
		<%
			out.println("<tr>");
			out.println("<td>"+ myrs.getString("Lname"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("LphoneNo"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("LAdd"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("aadharNo"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("TrackId"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("dateRecieved"));
			out.println("</td>");
...
%>
	...
	<br>
	<center>
	<h2>Enter Tracking ID Update Tenant Application:</h2>
	<form method="post" action="Update_Tenant">
