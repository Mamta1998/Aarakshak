	...
	try
{
	...
	String recipient=request.getParameter("email").replaceAll("\\s","");
	AdminPojo obj=new AdminPojo();
	obj.setEmail(recipient);
	String query="select password from admin where email=?";
	PreparedStatement myStmt=conn.prepareStatement(query);
	myStmt.setString(1,recipient);
...
%>
	...
	<% }
		...
		%>
		<p>Password is sent to your registered mail ID</p>
		
		<%
		obj.setPassword(myrs.getString("password"));
		EmailId email=new EmailId();
		email.resetPassword(obj);
		} 
	}
catch(Exception e)
{
