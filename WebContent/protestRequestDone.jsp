...
<!-- Site Metas -->
<title>Protest Application Submitted</title>
	...
	<section class="inner_banner">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="full">
						<h3>Protest/Strike Application Submitted</h3>
					</div>
				</div>
			</div>
		</div>
		...
		try
			{
				...
				ProtestPojo obj =new ProtestPojo();
				obj.setLine1(line1);
				obj.setLine2(line2);
				obj.setLine3(line3);
				...
				String tracking=db.protestRequest(obj);
