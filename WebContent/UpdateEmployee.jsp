...
<head>
    ...
    <!-- Site Metas -->
    <title>Update Employee verification Request</title>
	...
	<section class="inner_banner">
	  <div class="container">
	      <div class="row">
		      <div class="col-12">
			     <div class="full">
				     <h3>Update Employee verification Request</h3>
				 </div>
			  </div>
		  </div>
	  </div>
	...
	<!-- end section -->
		...
		<%
			...
			{	
				...
				String query="select * from employee where policestation=?";
...
<%
	...
	while(myrs.next())
		...
		<table id="customers">
			...
			<%
			out.println("<tr>");
			out.println("<td>"+ myrs.getString("eName"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("ePhone"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("eEmail"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("ePermanent"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("eCurrent"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("eReligion"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("eDOB"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("eGender"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("ePhysical"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("eBlood"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("eAadhar"));
			out.println("</td>");
			
			%>
		</table>
	<center><h1>Applicant's Details</h1></center>
	<table id="customers">
		<tr>
			<th>Name</th>
			<th>ContactNo</th>
		...
		<%
			...
			out.println("</td>");
			out.println("<td>"+ myrs.getString("organization"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("organizationAddress"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("aadhar"));
			out.println("</td>");
			out.println("<td>"+ myrs.getString("email"));
			out.println("</td>");
