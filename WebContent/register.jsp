			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="contact_form">
						<form method="post" action="complainDone.jsp">
							<fieldset>
						...
						placeholder="Your Address">
								...
								<div class="full field">
									<input type="text" id="aa" name="aadhar" required
						placeholder="Your Aadhar Number">
								</div>
								
									<div class="full field">
									<textarea id="fir" name="complaint" required
						placeholder="Your Complaint" style="height: 200px"></textarea>
								</div>
								<div class="full field">
									 <select name="policeStation" id="pp" required>
