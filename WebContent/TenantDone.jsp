...
try
{
	...
	String LPhoneNo=request.getParameter("LPhoneNo");
	String LAdd=request.getParameter("LAdd");
	String TName=request.getParameter("TName");
	String TFatherName=request.getParameter("TFatherName");
	String TOfficeAdd=request.getParameter("TOfficeAdd");
	String TCurrentAdd=request.getParameter("TCurrentAdd");
	String TPhoneNo=request.getParameter("TPhoneNo");
	String TPermanentAdd=request.getParameter("TPermanentAdd");
	...
	obj.setLName(Lname);
	obj.setLPhoneNo(LPhoneNo);
	obj.setLAdd(LAdd);
	obj.setTName(TName);
	obj.setTFatherName(TFatherName);
	obj.setTOfficeAdd(TOfficeAdd);
	obj.setTCurrentAdd(TCurrentAdd);
	obj.setTPermanentAdd(TPermanentAdd);
	obj.setTotalMember(totalMember);
	obj.setAadharNo(aadharNo);
	obj.setPoliceStation(policeStation);
	obj.setTrack(track_number);
	obj.setDateRecentlyUpdated(dateRecentlyUpdated);
	obj.setDateRecieved(dateRecieved);
	obj.setTPhoneNo(TPhoneNo);
	obj.setQuestion(question);
	obj.setAnswer(answer);
	
	
	Database db=new Database();
	String tracking=db.tenant(obj);
