...
<head>
    ...
    <!-- Site Metas -->
    <title>Form submitted Successful</title>
...
try
{
	...
	String eContact=request.getParameter("eConatct");
	String eEmail=request.getParameter("eEmail");
	String eFatherName=request.getParameter("eFatherName");
	String eAadhar=request.getParameter("eAadhar");
	String ePermanent=request.getParameter("pAddress");
	String eCurrent=request.getParameter("cAddress");
	String district=request.getParameter("district");
	String state=request.getParameter("state");
	String religion=request.getParameter("religion");
	String dob=request.getParameter("dob");
	String gender=request.getParameter("gender");
	String physically=request.getParameter("physical");
	String blood=request.getParameter("bloodgroup");
	String name=request.getParameter("name");
	String contact=request.getParameter("phone");
	String address=request.getParameter("address");
	String organization=request.getParameter("organiztion");
	String organizationAdd=request.getParameter("oAddress");
	...
	obj.seteName(eName);
	obj.seteContact(eContact);
	obj.seteAadhar(eAadhar);
	obj.seteBloodGroup(blood);
	obj.seteFatherName(eFatherName);
	obj.seteCurrent(eCurrent);
	obj.seteDOB(dob);
	obj.seteEmail(eEmail);
	obj.seteGender(gender);
	obj.setePermannent(ePermanent);
	obj.setePhysical(physically);
	obj.seteReligion(religion);
	...
	obj.setOrganizationAdd(organizationAdd);
	...
	String tracking=db.employee(obj);
	System.out.println("database done"); 
	
	%>
	<h1 style="color: #003366;"><b>Your application submitted Successfully</b></h1>
		<%
