<!-- Program for update Contact US Status -->
...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
	...
	<!-- end section -->
		...
		try
		{
			...
			String query="Select * from contact where Status IN('Pending','Later') AND policeStation=?";
			PreparedStatement myStmt=conn.prepareStatement(query);
			myStmt.setString(1,policeStation);
			ResultSet myrs=myStmt.executeQuery();
			if(myrs.next()==false)
			{
				out.println("No Queries Recieved");
			}
			else
			{
				int number=1;
...
<table id="customers">
		...
		while(myrs.next())
		{
			...
			out.println("</td>");
			out.println("<td>"+ myrs.getString("Message"));
			out.println("</td>");
...
<br>
	<br>
	<center>
	<h2> Select the Contact Number to Update:</h2>
