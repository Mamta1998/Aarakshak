...
<!-- Program for taking entries from user for filling FIR Form -->
...
<!-- Site Metas -->
<title>Tenanat Verification Form</title>
	...
	<section class="inner_banner">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="full">
						<h3>Tenanat Verification Form</h3>
					</div>
				</div>
			</div>
		</div>
...
<button class="p" onclick="window.print()">Print</button>
			...
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-12">
					<div class="full float-right_img">
						<img src="images/tenant.jpg" alt="#">
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="contact_form">
						<form method="post" action="TenantDone.jsp">
							<fieldset>
							<b><h2><u>Landlord Details</u></h2></b>
								<div class="full field">
								<input type="text" name="LName" placeholder="Name" required>
						
								</div>
								<div class="full field">
									<input type="text" name="LPhoneNo" placeholder="Phone Number(Office)" required>
								</div>
								<div class="full field">
									<input type="text" name="LAddress" placeholder="Permanent Address" required>
					</div>
								<b><h2><u>Tenant Details</u></h2></b>
								<div class="full field">
									<input type="text" name="TName" placeholder="Name" required>
								</div>
								
									<div class="full field">
									<input type="text" name="TFatherName" placeholder="Father's Name" required>
								</div>
								<div class="full field">
									<input type="text" name="TPhoneNo" placeholder="Phone Number" required>
								</div>
								<div class="full field">
									<input type="text" name="TCurrentAdd" placeholder="Current Address" required>
								</div>
								<div class="full field">
									<input type="text" name="TPermanentAdd" placeholder="Permanent Address" required>
								</div>
								<div class="full field">
									<input type="text" name="TOfficeAdd" placeholder="Office Address" required>
								</div>
								<div class="full field">
									<input type="text" name="totalMember" placeholder="Total Members in Family" required>
								</div>
								<div class="full field">
				...
				%>
								...
								<div class="full field">
									<div class="center">
										<button onclick="return confirm('Make sure details provided by you is valid otherwise necessary action can be taken against you by authority');">Submit</button>
									</div>
								</div>
							</fieldset>
						</form>
	...
	<div class="footer_bottom">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<p class="crp">© Copyrights By Aarakshak</p>
				</div>
			</div>
		</div>
	</div>
