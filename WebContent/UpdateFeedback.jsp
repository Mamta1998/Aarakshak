...
try
{
	...
	String query="Select * from feedback where (Status='Pending'or Status='later') AND (Name IS NOT NULL)";
	PreparedStatement myStmt=conn.prepareStatement(query);
	ResultSet myrs=myStmt.executeQuery();
	if(myrs.next()==false)
	{
		out.println("No Feedback to Update");
	}
	else
	{ int number=1;
...
while(myrs.next())
{
	...
	out.println("</td>");
	out.println("<td>"+ myrs.getString("Feedback"));
	out.println("</td>");
