...
try
{
	...
	String hPhone=request.getParameter("hPhoneNo");
	String hAddress=request.getParameter("hAddress");
	String hCaste=request.getParameter("hCaste");
	String hReligion=request.getParameter("hReligion");
	String hGender=request.getParameter("gender");
	String hAadhar=request.getParameter("hAadhar");
	String pName=request.getParameter("pName");
	String pPhone=request.getParameter("pContactNo");
	...
	obj.sethContact(hPhone);
	obj.sethAadhar(hAadhar);
	obj.setpName(pName);
	obj.setCaste(hCaste);
	obj.setReligion(hReligion);
	obj.setGender(hGender);
	obj.setpContact(pPhone);
	obj.setpAddress(pAddress);
	obj.setName(name);
	obj.setAddress(address);
	obj.setContact(phone);
	...
	String tracking=db.domestic(obj);
