<!-- Program to update status of  procession  request application received -->
...
<head>
    ...
    <!-- Site Metas -->
    <title>Update Procession Request Application</title>
...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <%
		...
		<a href="adminLogout.jsp" class = "session-Logout"> Admin Logout</a>
		</p>
	</div>
	<!-- section -->
	...
	<section class="inner_banner">
	  <div class="container">
	      <div class="row">
		      <div class="col-12">
			     <div class="full">
				     <h3>Update Procession Request Application</h3>
				 </div>
			  </div>
		  </div>
	  </div>
	...
	<%
		...
		int total=1;
			...
			String query="select * from procession where status IN('Pending','Recieved','Under Process','Opened') AND policeStation=?";
...
%>	<h1><center>Application for permission of Procession Request</center> </h1>
		<p>
			<br><br>
			To,<br>
			<%	out.println( myrs.getString("line1")); %><br>
			<%out.println( myrs.getString("line2")); %>
			<br>
			<%	out.println( myrs.getString("line3")); 
			%>
			<br>
			<br>
			Subject:<%out.println( myrs.getString("subject"));  %><br><br><br>
			Respected Sir/Madam,<br><br>
			<%out.println( myrs.getString("content"));  %>
			<br>
			<br>
			Thanking You,<br>
			Your Sincerely<br>
			...
			<%
			out.println(myrs.getString("designation"));
				%><br>
	</p>
...
<br>
<center>
	<h2> Enter TrackId to Update:</h2>
		<form method="post" action="UpdateProcession">
