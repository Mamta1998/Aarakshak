                ...
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="Tenant.jsp" ><h2><span>Tenant Verification Form</span></h2></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="employeeVerification.jsp" ><h2><span>Employee Verification Form</span></h2></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="domesticHelpVerification.jsp" ><h2><span>Domestic Help Verification Form</span></h2></a>
                        </div>
