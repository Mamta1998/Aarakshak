...
<head>
    ...
    <!-- Site Metas -->
    <title>Update Protest Application</title>
	...
	<section class="inner_banner">
	  <div class="container">
	      <div class="row">
		      <div class="col-12">
			     <div class="full">
				     <h3>Update Protest Application</h3>
				 </div>
			  </div>
		  </div>
	  </div>
	...
	try
		{
			...
			String query="select * from protest where status IN('Pending','Recieved','Under Process','Opened') AND policeStation=?";
...
%>	<h1><center>Application for permission of Protest</center> </h1>
		<p>
			<br><br>
			To,<br>
...
<center>
	<h2> Enter TrackId to Update:</h2>
		<form method="post" action="UpdateProtest">
			<input type="text" name="trackid" />
			<select name="status">
				<option disabled selected>Select Update</option>
				<option value="Recieved">Recieved</option>
				<option value="Under Process">Under Processs</option>
