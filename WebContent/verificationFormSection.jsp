...
<head>
    ...
    <!-- Site Metas -->
    <title>VerificationFormSection</title>
                ...
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="adminEmployee.jsp" ><h2><span>Employee verification Request</span></h2></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="adminTenant.jsp" ><h2><span>Tenant verification Request</span></h2></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="adminDomestic.jsp" ><h2><span>Domestic Help Verification Request</span></h2></a>
                        </div>
