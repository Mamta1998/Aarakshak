<!-- Program for dealing with the application comes under event organize request -->
<!-- Program for dealing with the application comes under event organize request -->
...
<head>
    ...
    <!-- Site Metas -->
    <title>Event Organize Section</title>
	...
	<section class="inner_banner">
	  <div class="container">
	      <div class="row">
		      <div class="col-12">
			     <div class="full">
				     <h3>Event Organize Request Section</h3>
				 </div>
			  </div>
		  </div>
	  </div>
                ...
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="adminFlimShooting.jsp" ><h2><span>Flim Shooting Request</span></h2></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="adminProcession.jsp" ><h2><span>Procession Request</span></h2></a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 layout_padding_2">
                    <div class="full">
                        <div class="heading_main text_align_left">
						   <a href="adminProtest.jsp"><h2><span>Protest/Strike Request</span></h2></a>
                        </div>
