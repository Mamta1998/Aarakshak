	...
	<section class="inner_banner">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="full">
						<h3>Film Shooting Application Submitted</h3>
					</div>
				</div>
			</div>
		</div>
...
try{
	...
	String policeCity=request.getParameter("policeCity");
	String policeAddress=request.getParameter("policeAddress");
	String shootingAddress=request.getParameter("shootingAddress");
	String name=request.getParameter("name");
	String designation=request.getParameter("designation");
	String companyName=request.getParameter("company");
	String companyAddress=request.getParameter("companyAddress");
	String shootingDate=request.getParameter("shootingDate");
	String shootingTime=request.getParameter("shootingTime");
	String totalMemeber=request.getParameter("members");
	String contact=request.getParameter("signature");
	String signature=request.getParameter("contact");
	...
	obj.setPoliceCity(policeCity);
	obj.setPoliceAddress(policeAddress);
	obj.setShootingLocation(shootingAddress);
	obj.setName(name);
	obj.setDesignation(designation);
	obj.setCompanyName(companyName);
	obj.setCompanyAddress(companyAddress);
	obj.setShootingDtae(shootingDate);
	obj.setShootingTime(shootingTime);
	obj.setMembers(totalMemeber);
	...
	String tracking=db.filmShootingRequest(obj);
