<!-- Program to view all procession request application received -->
...
<head>
    ...
    <!-- Site Metas -->
    <title>Procession Request Application</title>
	...
	<section class="inner_banner">
	  <div class="container">
	      <div class="row">
		      <div class="col-12">
			     <div class="full">
				     <h3>Procession Request Application</h3>
				 </div>
			  </div>
		  </div>
	  </div>
	...
	try
		{
			...
			String query="select * from procession where policeStation=?";
...
<table id="customers">
	...
	<p>
		<br><br>
		To,<br>
		<%	out.println( myrs.getString("line1")); %>
		<br>
		...
		<br>
		<br>
		Subject:<%out.println( myrs.getString("subject"));  %>
		<br><br><br>
		Respected Sir/Madam,
		<br><br>
		...
		<%out.println(myrs.getString("designation"));%><br>
	</p>
