...
<!-- Program for tracking FIR Complaint -->
...
<body>
	...
	<%
			try {
				...
				String track = request.getParameter("track").replaceAll("\\s","");
				String state = null;
				
				Connection conn = DBConnection.getConnection();
				String query = "Select * from register where TrackID=?";
...
<a href="index.html"><h1>Home</h1></a>
	...
	<%} else if (state.equals("Under Processs")) { %>
	<span style='font-size: 50px; margin-left: 5%;'>&#9989;</span>
	<span style='font-size: 50px; margin-left: 3%;'>&#9989;</span>
	<span style='font-size: 50px; margin-left: 3%;'>&#9989;</span>
