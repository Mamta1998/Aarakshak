...
<head>
    ...
    <!-- Site Metas -->
    <title>PoliceStation List</title>
...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
	...
	<!-- end section -->
	<h1 ><i><u><center>Police Stations</center></u></i></h1>
<%
try
{
...
<br>
<br>
<<h1 ><i><u><center>For Map Guide</center></u></i></h1>
<form method="post" action="policeStaionLocation.jsp">
<center>Select your police station: 
			...
			<%	try
				{
					Connection myCon1 = DBConnection.getConnection();
						...
						ResultSet myRes1 = mySmt1.executeQuery("select * from policeStation");
						while (myRes1.next()) {
							String station= myRes1.getString("Name");
